...
class CalendarCtrl3 extends React.Component {
    constructor(props) {
        super(props);
        console.log("%cprops in CalendarCtrl3: ", "color: blue; font-size: large")
        console.log(props);
    ...
    render() {
        ...
        return (
            <div className='calendar-ctrl'>
                ...
                {/*<span className="link"><Link to={links[0][0]} onClick={(e) => this.handleClickLinkNextY(this.state.year, this.state.month, e)} onMouseDown={(e) => this.handleNextYear(this.state.year, this.state.month, e)} onMouseUp={this.clearPressureTimer}>{links[0][1]}</Link></span>*/}
                {/*<span className="link"><Link to={links[1][0]} onClick={(e) => this.handleClickLinkPrevY(this.state.year, this.state.month, e)} onMouseDown={(e) => this.handlePreviousYear(this.state.year, this.state.month, e)} onMouseUp={this.clearPressureTimer}>{links[1][1]}</Link></span>*/}
                ...
                <div className="tooltip">
                    ...
                    <span className="span arrow-up" ref={this.spanYNext} onMouseDown={!this.state.timerIsOn && this.state.year !== thisYear ? (e) => this.handleNextYear(e) : this.infoMessage} onTouchStart={!this.state.timerIsOn && this.state.year !== thisYear ? (e) => this.handleNextYear(e) : this.infoMessage} onMouseUp={this.clearPressureTimer} onTouchEnd={this.clearPressureTimer} onClick={this.handleClickSpan}>
                        {/*<Link ref={this.JSXLink} /*{(el) => this._link = el}*/ /*className="linkelink" to={links[0][0]} onMouseDown={!this.state.timerIsOn ? (e) => this.handleNextYear(/*this.state.year, this.state.month,*/ /*e) : this.infoMessage} onMouseUp={this.clearPressureTimer} onClick={(e) => { console.log("A click event on arrow-up"); e.preventDefault()}}>{links[0][1]}</Link>*/}
                    ...
                    <span className="span arrow-down" ref={this.spanYPrev} onMouseDown={!this.state.timerIsOn ? (e) => this.handlePreviousYear(e) : this.infoMessage} onMouseUp={this.clearPressureTimer} onTouchStart={!this.state.timerIsOn && this.state.year !== thisYear ? (e) => this.handlePreviousYear(e) : this.infoMessage} onTouchEnd={this.clearPressureTimer} onClick={this.handleClickSpan}>
                        {/*<Link to={links[1][0]} onMouseDown={(e) => this.handlePreviousYear(/*this.state.year, this.state.month,*/ /*e)} onMouseUp={this.clearPressureTimer}>{links[1][1]}</Link>*/}
                ...
                <span className="span arrow-up">
                    <Link to={links[2][0]} className="link arrow-up" onClick={!(this.state.year === thisYear && this.state.month === thisMonth) ? (e) => this.handleClickLinkNextM(this.state.year, this.state.month, e) : this.infoMessage }>{links[2][1]}</Link>
                </span>
